...
export default function DestinationSelect({
  ...
  return (
    <div className="relative min-w-0 w-full" ref={wrapperRef} onKeyDown={handleKeyDown}>
      ...
      {isOpen && (
        <div className="absolute z-50 mt-3 w-full overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl shadow-slate-200/70">
          <div className={`border-b border-slate-100 p-3 ${accent.bg}`}>
            <div className="relative">
              ...
              <input
                ...
                className="min-h-11 w-full rounded-2xl border border-slate-200 bg-white py-2.5 pl-10 pr-3 text-sm font-semibold text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/10"
                value={search}
                onChange={(event) => {
