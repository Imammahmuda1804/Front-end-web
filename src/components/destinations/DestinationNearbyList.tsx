...
export function DestinationNearbyList({
  ...
  return (
    <div className="rounded-xl border border-sky-100 bg-sky-50/60 p-6 shadow-sm">
      ...
      <div className="mt-4 space-y-3">
        {destinations.map((item) => (
          <Link
            ...
            className="block rounded-xl border border-sky-100 bg-white p-4 transition hover:border-ai/30 hover:text-ai"
          >
