  ...
  return (
    <Card className="rounded-[1.75rem] border border-slate-200 bg-white py-0 shadow-sm">
      ...
      <CardContent className="p-6">
        {data.length === 0 ? (
          <div className="flex h-80 items-center justify-center rounded-3xl border border-dashed border-slate-200 text-sm font-bold text-slate-400">
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_18rem]">
            ...
            <div className="space-y-3">
              ...
              {hiddenGems.length > 0 ? hiddenGems.map((destination) => (
                <Link key={destination.id} href={`/admin/destinations/${destination.id}`} className="block rounded-2xl border border-slate-200 bg-slate-50 p-3 transition-colors hover:border-orange-200 hover:bg-orange-50">
                ...
                <p className="rounded-2xl border border-slate-200 bg-slate-50 p-3 text-sm font-bold text-slate-500">
